 ...
 * @package nidavellir
 *
 * Color Patterns have been helped along thanks to the fine work of the TwentyNineteen theme
 ...
 */
function nidavellir_custom_colors_css() {

	$primary_color = 240;
	if ( 'default' !== get_theme_mod( 'primary_color', 'default' ) ) {
		$primary_color = absint( get_theme_mod( 'primary_color_hue', 240 ) );
	}
	 ...
	 */
	$saturation = apply_filters( 'nidavellir_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter default selection saturation level.
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'nidavellir_custom_colors_saturation_selection', 50 ) );
	 ...
	 */
	$lightness = apply_filters( 'nidavellir_custom_colors_lightness', 33 );
	 ...
	 */
	$lightness_hover = apply_filters( 'nidavellir_custom_colors_lightness_hover', 23 );
	 ...
	 */
	$lightness_selection = apply_filters( 'nidavellir_custom_colors_lightness_selection', 90 );
	 ...
	 */
	return apply_filters( 'nidavellir_custom_colors_css', $theme_css, $primary_color, $saturation );
}
